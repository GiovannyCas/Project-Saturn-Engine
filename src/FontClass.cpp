#include "../src/header/FontClass.h"
...
bool FontClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int fontChoice)
{
    ...
    case 0:
    {
        strcpy_s(fontFilename, "resources/font/font01.txt");
        strcpy_s(fontTextureFilename, "resources/font/font01.tga");
        m_fontHeight = 32.0f;
        m_spaceSize = 3;
        break;
    }
...
void FontClass::BuildVertexArray(void* vertices, char* sentence, float drawX, float drawY)
{
    ...
    for (i = 0; i < numLetters; i++)
    {
        ...
        else
        {
            ...
            vertexPtr[index].position = DirectX::XMFLOAT3((drawX + m_Font[letter].size), (drawY - m_fontHeight), 0.0f);  // Bottom right.
