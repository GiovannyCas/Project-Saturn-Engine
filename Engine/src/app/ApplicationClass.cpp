...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	m_Direct3D = new DX::DirectXClass;
	...
	m_Timer = new Utility::TimerClass;
	if (!m_Timer)
	{
		return false;
	}
	...
	m_Scene = new Utility::SceneClass;
	if (!m_Scene)
	{
		return false;
	}
