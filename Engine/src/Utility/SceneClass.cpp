...
bool Utility::SceneClass::Initialize(DX::DirectXClass* Direct3D, HWND hwnd, int screenWidth, int screenHeight, float screenDepth)
{
	bool result;

	// Create the camera object.
	m_Camera = new Camera::CameraClass;
	if (!m_Camera)
	{
		return false;
	}
...
void Utility::SceneClass::Shutdown()
{
...
bool Utility::SceneClass::Frame(DX::DirectXClass* Direct3D, Input::InputClass* Input, Shader::ShaderManagerClass* ShaderManager, float frameTime)
{
	bool result;
...
void Utility::SceneClass::HandleMovementInput(Input::InputClass* Input, float frameTime)
{
	bool keyDown;
	float posX, posY, posZ, rotX, rotY, rotZ;
...
bool Utility::SceneClass::Render(DX::DirectXClass* Direct3D, Shader::ShaderManagerClass* ShaderManager)
{
